...
HID_DEVICE_COLLECTION *osx_hid_scan(int type, HID_DEVICE_COLLECTION* col)
{
   ...
   {   
      ...
      this_device->manufacturer = strdup([((NSString*) [properties objectForKey: @kIOHIDManufacturerKey]) UTF8String]);
      this_device->product = strdup([((NSString*) [properties objectForKey: @kIOHIDProductKey]) UTF8String]);
